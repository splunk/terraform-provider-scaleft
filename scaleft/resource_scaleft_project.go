...
func resourceScaleftProject() *schema.Resource {
	return &schema.Resource{
		Create: resourceScaleftProjectCreate,
		Read:   resourceScaleftProjectRead,
		Update: resourceScaleftProjectUpdate,
		Delete: resourceScaleftProjectDelete,
...
func resourceScaleftProjectCreate(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
	...
	return resourceScaleftProjectRead(d, m)
}
...
func resourceScaleftProjectRead(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
	projectName := d.Id()
...
func resourceScaleftProjectUpdate(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
...
func resourceScaleftProjectDelete(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
