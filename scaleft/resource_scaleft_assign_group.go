...
func resourceScaleftAssignGroup() *schema.Resource {
	return &schema.Resource{
		Create: resourceScaleftAssignGroupCreate,
		Read:   resourceScaleftAssignGroupRead,
		Update: resourceScaleftAssignGroupUpdate,
		Delete: resourceScaleftAssignGroupDelete,
...
func resourceScaleftAssignGroupCreate(d *schema.ResourceData, m interface{}) error {
	...
	return resourceScaleftAssignGroupRead(d, m)
}
...
func resourceScaleftAssignGroupRead(d *schema.ResourceData, m interface{}) error {
...
func resourceScaleftAssignGroupUpdate(d *schema.ResourceData, m interface{}) error {
	return resourceScaleftAssignGroupCreate(d, m)
}

func resourceScaleftAssignGroupDelete(d *schema.ResourceData, m interface{}) error {
	token := m.(Bearer)
